                            ...
                            if (rfy !== year) {
                            	if(yearArr.length==1){
                                    ...
                                    ('<div class="row header year" style="width: '
                                        + (tools.getCellSize() * daysInYear-24)
                            ...
                            */
                            ...
                            if (rm !== month) {
                            	if(monthArr.length==1){
                                    ...
                                    + (tools.getCellSize() * daysInMonth-23) + 'px"><div class="fn-label">'
                                    + settings.months[month]+'('+rday.getFullYear()+')'
                                    + '</div></div>'));
                        ...
                        .append($('<div class="nav-slider" />')
                            .append($('<div class="nav-slider-left" />')
                                ...
                                .append($('<div class="page-number"/>')
                                        .append($('<span/>')
                                            .html(cust.currPage + 1 + ' of ' + cust.pages)))
